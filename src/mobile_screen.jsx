        ...
        <>
            ...
            <div className={style.contentScreen}>
                <div style={{width: '85vw'}}> 
                    ...
                    <div {...animatedItem[1]}>
                        <p style={{marginTop :'100px', textAlign: 'right', fontWeight : 'bold' , fontSize :'18px', textDecoration : 'underline'}}>노년기에 충분한 여가활동을 <br/>
                        누리고 있지 못한다.</p> 
                    </div>
                    <div {...animatedItem[2]}>
                        <p style={{marginTop :'150px', }}>'다올'은 시니어들의 자아실현에 주목합니다.</p>
                        <p style={{marginTop :'50px', }}>시니어들의 자아실현을 위한 <br/>
                            여가 프로그램을 진행합니다.</p>
                    </div>
                    ...
                    <div {...animatedItem[4]}>
                        <label style={{marginTop :'100px'}}>'다올'은 <br/>
                            ...
                            <p style={{marginTop :'50px', }}>'시립용산노인 종합 복지관'과 협업하여<br/>
                ...
                <div style={{marginTop:'100px', marginBottom : '100px' , width: '85vw'}}>
                    ...
                    <div {...animatedItem[7]}>
                        ...
                        <p style={{marginTop :'50px', }}>인스타그램을 통해 <br/>
